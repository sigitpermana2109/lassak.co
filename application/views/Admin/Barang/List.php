...
<div class="main-content">
  ...
  <?php foreach ($barang as $row) { ?>
    ...
    <!-- Modal Hapus -->
    <div class="modal fade" tabindex="-1" id="modalHapus<?= $row['id_barang']; ?>" role="dialog" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <form class="forms-sample" id="addForm" method="POST" enctype="multipart/form-data" action="<?= base_url('Admin/Barang/manajemen');  ?>">
            ...
            <div class="form-group">
              ...
              <input type="file" id="gambar1" name="gambar1" class="form-control" onchange="loadFile(event)" /><br>
