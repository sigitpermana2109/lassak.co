...
?>
<body style="background-image: url('<?= base_url('assets/frontend/img/banner/background7.png'); ?>');background-size: cover;">
  <div id="app">
          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-success">
              <div class="card-header text-center">
                <h4 class="h3-responsive font-weight-bold">Login</h4>
              </div>
              <?= $this->session->flashdata('message'); ?>
              <div class="card-body">
                <form method="POST" action="<?= base_url('Auth_admin'); ?>" class="needs-validation" novalidate="">
