    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar ">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user font-weight-bold">
            <img alt="image" src="<?= base_url('assets/images/faces/'.$admin_user['foto']); ?>" class="rounded-circle mr-1">
            <div class="d-sm-none d-lg-inline-block"><?= $admin_user['nama_lengkap']; ?></div></a>
            <div class="dropdown-menu dropdown-menu-right">
              <div class="dropdown-title"></div>
              <a href="<?= base_url('Admin/Admin/Profile'); ?>" class="dropdown-item has-icon">
      ...
      <div class="modal-dialog modal-sm modal-notify modal-danger" role="document">
        ...
        <div class="modal-content text-center">
          ...
          <div class="modal-footer flex-center">
            <a href="<?= base_url('Auth_admin/logout'); ?>" class="btn  btn-outline-danger">Yes</a>
